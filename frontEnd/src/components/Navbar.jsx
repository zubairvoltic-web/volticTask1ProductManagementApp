  ...
  return (
    <div>
       <nav className='w-full h-16 flex  items-center justify-between px-4 md:px-6 bg-slate-950 text-white'>
        ...
        <div>
            <button className='bg-teal-400 text-slate-950 px-4 py-2 rounded-lg font-semibold hover:bg-teal-300 hover:shadow-lg transition duration-300'><a href="/adminLogin">LogOut</a></button>
        </div>
       </nav>
    </div>
  )
